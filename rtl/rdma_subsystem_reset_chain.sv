...
module rdma_subsystem_reset_chain (
    ...
    output logic      sq_fetcher_reset_n,
    ...
    always_ff @(posedge clk or negedge reset_n) begin : reset_synchronizers
        if (!reset_n) begin
            ...
            sq_fetcher_sync     <= {sq_fetcher_sync[0], 1'b1};
    ...
    assign sq_fetcher_reset_n  = sq_fetcher_sync[1];
